...
import tdtu.finalapp.musicapp.Adapter.AdapterSongOfDetailPlaylist;
    ...
    void setSongIntoRecycleView(){
        ...
        if(lstSongOfPlaylist != null){
            ...
            if(SongsArrayList.size() <=0){
                ...
                AdapterSongOfDetailPlaylist adapterSong = new AdapterSongOfDetailPlaylist(DetailPlaylistActivity.this, SongsArrayList,passValue_playlist);
